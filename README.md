...
+ 送礼设置优先级:  
  送满全部勋章>优先送礼房间>送礼优先高等级粉丝牌。  
+ 送礼设置逻辑规则:  
  1. 如果勾选了送满全部勋章，会给按顺序依次给所有勋章送礼，无视礼物过期时间。
  2. 如果未勾选送满全部勋章，那么会先给优先送礼房间送礼（前提是你得有优先房间的粉丝勋章），然后再给剩下粉丝勋章中等级由高到低的牌子送礼。  
  3. 如果只指定了优先送礼房间，则会先给优先房间送出即将过期的礼物。若送满亲密度后还有将要过期的礼物，就从粉丝勋章列表第一个未指定的房间开始，把将要过期的礼物送给粉丝勋章列表中的粉丝牌。  
