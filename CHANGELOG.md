...
- 删除【亲密喂养】模块及活动相关的 API 封装（B站超能粉丝节亲密喂养活动已结束）

## [7.3.7] - 2026-9-13

### 新增

- 【亲密喂养】模块新增【领取并赠送喵崽的馈赠】按钮，按下后为所有符合条件的粉丝勋章领取喵崽的馈赠礼物并赠送给主播

## [7.3.6] - 2026-8-27

### 修复

- 修复粉丝勋章名单中同一个勋章重复出现的bug（B站接口有概率重复返回同一个勋章）

### 调整

- 优化【隐藏/显示控制面板】按钮样式，不占用B站原生元素空间；如果空间不足与B站活动组件发生重叠，按钮会显示在上方
- 直播任务板块部分日志优化
...
- 【亲密喂养】修复无法正确判断直播间是否支持亲密喂养活动的问题，改为使用直播画面上方右侧是否有亲密喂养活动组件（挂件）作为判定依据

## [7.3.4] - 2026-8-25

### 新增

- 新增【亲密喂养】模块，自动完成亲密喂养活动（B站超能粉丝节的养猫活动）的选猫，每日签到，喂猫粮和撸猫。支持黑白名单
- 优化【屏蔽挂机检测】模块，使其尽早运行；增加页面焦点状态属性的修改

### 调整

- 亲密度储蓄提示日志的等级提升为警告（`console.warn`）
