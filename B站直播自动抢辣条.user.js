...
if(MY_API.Gift.time<=0)MY_API.Gift.time=ts_s();if(!MY_API.CONFIG.SEND_ALL_GIFT){let pass=MY_API.Gift.bag_list.filter(r=>MY_API.Gift.sendGiftList.includes(r.gift_id)&&r.gift_num>0&&r.expire_at>MY_API.Gift.time&&(r.expire_at-MY_API.Gift.time<MY_API.CONFIG.GIFT_LIMIT*86400)&&r.corner_mark!='永久');if(pass.length==0){MY_API.Gift.over=true;return;}else{MY_API.bag_list=pass;}}
