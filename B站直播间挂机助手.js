...
// @require        https://cdn.jsdelivr.net/gh/andywang425/BLTH@7d073f782c34287efb0532b4301996293847ecf8/assets/js/library/BilibiliAPI_Mod.min.js
...
// @resource       main     https://cdn.jsdelivr.net/gh/andywang425/BLTH@6ab29ac70d6a7e043990062e95199ee906f088ad/assets/html/main.min.html
      ...
      buyFanMedal: (room_id) => {
        return BAPI.live_user.get_anchor_in_room(room_id).then(function (response) {
          ...
          if (response.code === 0 && response.data.info) {
            ...
            layer.confirm(`<div style = "text-align:center">是否消耗5B币购买UP主<br>${linkMsg("https://space.bilibili.com/" + uid, uname)}<br>的粉丝勋章？</div>`, {
        ...
        const openMainWindow = () => {
          ...
          mainIndex = layer.open({
            ...
            success: () => {
              ...
              // 显示输入框的值
              myDiv.find('div[data-toggle="getNewerLiveStream"] .num').val(SP_CONFIG.liveStreamLead.toString());
