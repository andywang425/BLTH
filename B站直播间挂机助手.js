...
// @resource       main     https://cdn.jsdelivr.net/gh/andywang425/BLTH@8ce90a7af779d32f771f9f04e5c0a40cb8b105fb/assets/html/main.min.html
                      ...
                      (function PP_notice() {
                        ...
                        return PP_sendMsg(data).then((re) => {
                          ...
                          if (re.body.code == 200) {
                            ...
                            window.toast(`[实物抽奖] 方糖中奖提示发送失败 ${re.body.msg}`, 'error')
                          }
                          return $.Deferred().resolve();
                        }), () => {
                  ...
                  (function PP_notice() {
                    ...
                    return PP_sendMsg(data).then((re) => {
                      ...
                      if (re.body.code == 200) {
                        ...
                        window.toast(`[天选时刻] 方糖中奖提示发送失败 ${re.body.msg}`, 'error')
                      }
                      return $.Deferred().resolve();
                    }, () => {
