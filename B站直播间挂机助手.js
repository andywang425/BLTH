        ...
        const MY_API = {
            ...
            creatSetBox: async () => {
                ...
                const helpText = {
                    ...
                    ANCHOR_FOLLOWING: "仅参与已关注且开播的直播间的天选时刻。获取到的房间列表会缓存起来以供后续使用。"
                };
            ...
            AnchorLottery: {
                ...
                run: async () => {
                    ...
                    switch (MY_API.CONFIG.ANCHOR_TYPE) {
                        case 'ANCHOR_POLLING': { //轮询
