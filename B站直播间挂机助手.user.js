...
return p},newMessage:(version)=>{try{const cache=localStorage.getItem(`${NAME}_NEWMSG_CACHE`);if((cache==undefined||cache==null||cache!='4.5.1')&&version=='4.5.1'){const linkMsg=(msg,link)=>{return'<a href=\"'+link+'\"target=\"_blank\">'+msg+'</a>';};layer.open({title:`${version}更新提示`,content:`<strong>1.金宝箱抽奖新增忽略关键字功能</strong><br>
                            2.UI细节优化<br>
                            3.金宝箱抽奖日志优化<br>
