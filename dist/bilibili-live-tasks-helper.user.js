...
// @require         https://unpkg.com/vue@3.4.15/dist/vue.global.prod.js
// @require         data:application/javascript,%3Bwindow.Vue%3DVue%3Bwindow.VueDemi%3DVue%3B
// @require         https://unpkg.com/element-plus@2.5.3/dist/index.full.min.js
...
// @require         https://unpkg.com/hotkeys-js@3.13.5/dist/hotkeys.min.js
// @require         https://unpkg.com/luxon@3.4.4/build/global/luxon.min.js
// @require         https://unpkg.com/crypto-js@4.2.0/crypto-js.js
// @resource        element-plus/dist/index.css  https://unpkg.com/element-plus@2.5.3/dist/index.css
...
(e=>{if(typeof GM_addStyle=="function"){GM_addStyle(e);return}const a=document.createElement("style");a.textContent=e,document.head.append(a)})(" .title[data-v-b935cab6]{padding-left:20px;align-items:center;display:flex}.header-big-text[data-v-b935cab6]{font-size:var(--big-text-size)}.header-small-text[data-v-b935cab6]{font-size:var(--small-text-size);padding-top:calc(var(--big-text-size) - var(--small-text-size));margin-left:10px;--small-text-size: 18px}.collapse-btn[data-v-b935cab6]{display:flex;justify-content:center;align-items:center;height:100%;float:left;cursor:pointer}.avatar-wrap[data-v-5d95554a]{width:80px;height:80px}.avatar[data-v-5d95554a]{display:flex;justify-content:center;align-items:center;border-radius:50%}.base[data-v-0fb8057a]{z-index:1003;position:absolute;background-color:#fff;border-bottom:1px solid #e3e5e7;border-left:1px solid #e3e5e7;border-right:1px solid #e3e5e7}.header[data-v-0fb8057a]{position:relative;box-sizing:border-box;width:100%;font-size:var(--big-text-size);align-items:center;display:flex;border-bottom:1px solid #e3e5e7;height:60px;--big-text-size: 25px}.aside[data-v-0fb8057a]{width:auto}.aside #aside-el-menu[data-v-0fb8057a]:not(.el-menu--collapse){width:150px}.main[data-v-0fb8057a]{--main-top-botton-padding: calc(var(--el-main-padding) * .625);padding-top:var(--main-top-botton-padding);padding-bottom:var(--main-top-botton-padding)}.fade-enter-active[data-v-0fb8057a],.fade-leave-active[data-v-0fb8057a]{transition:opacity .1s ease}.fade-enter-from[data-v-0fb8057a],.fade-leave-to[data-v-0fb8057a]{opacity:0}.info-icon[data-v-a94848d9]{font-size:var(--el-font-size-base);cursor:pointer}.status-icon[data-v-72d53133]{font-size:var(--el-font-size-base)}.blth_btn{background-color:#23ade5;font-size:small;margin-inline-start:5px;color:#fff;border-radius:4px;border:none;padding:5px;cursor:pointer;box-shadow:0 0 2px #00000075;line-height:10px;margin-left:15px}.blth_btn:hover{background-color:#1097cc}.blth_btn:hover:active{background-color:#0e86b6;position:relative;top:1px} ");
...
(async function (vue, pinia$1, _, ElementPlusIconsVue, luxon, CryptoJS, ElementPlus, hotkeys) {
  ...
  __publicField(WearFansMedal, "runAfterDefault", false);
  ...
  const _withScopeId$1 = (n) => (vue.pushScopeId("data-v-5d95554a"), n = n(), vue.popScopeId(), n);
  ...
  const LiveTasks = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-5d95554a"]]);
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => vue.unref(config).removeMicPopover.enabled = $event),
              ...
              vue.createVNode(_component_el_space, { wrap: "" }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_el_switch, {
                    ...
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => vue.unref(config).removeComboCard.enabled = $event),
  ...
  const _withScopeId = (n) => (vue.pushScopeId("data-v-a94848d9"), n = n(), vue.popScopeId(), n);
  ...
  const InfoIcon = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a94848d9"]]);
