      ...
      medalTasks: {
        ...
        like: {
          ...
          message: h('p', [
            ...
            h('ul', [
              h('li', '只有主播开播时点赞才会计入任务进度，因此只会给开播中的直播间点赞。'),
              h(
                'li',
                '脚本会根据 B 站返回的任务要求自动决定点赞次数。高等级的粉丝勋章拥有更高的任务上限，因此能获得更多的亲密度。',
              ),
            ]),
          ]),
        },
        danmu: {
          ...
          message: h('p', [
            ...
            h('ul', [
              h(
                'li',
                '脚本会根据 B 站返回的任务要求自动决定发送条数。高等级的粉丝勋章拥有更高的任务上限，因此能获得更多的亲密度。',
              ),
              h(
                'li',
                '点击【编辑弹幕】按钮编辑要发送的弹幕，脚本会从中按顺序循环抽取弹幕发送。建议修改默认的弹幕。',
              ...
              h(
                'li',
                '若担心直播中刷屏被禁言，可开启【仅在未开播的直播间发弹幕】，此时会跳过当前正在直播的直播间。',
              ),
